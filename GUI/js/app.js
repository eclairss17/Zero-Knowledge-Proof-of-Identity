...
//web3.eth.defaultAccount = web3.eth.accounts[0];
    ...
    handleSubmittingTenAnswer: function () {
        let puzzleId = 0
        let input = JSON.parse($('#public-array-input').val())
        App.handleSubmittingAnswer('#ten-loading', '#ten-action-button', "#ten-proof-input", "#ten-verified", puzzleId, input)
    },
   ...
   // handleSubmittingMagicAnswer: function () {
    ...
    handleSubmittingOtherAnswer: function () {
        ...
        let input = JSON.parse($('#public-array-input').val())
        App.handleSubmittingAnswer('#other-loading', '#other-action-button', "#other-proof-input", "#other-verified", puzzleId, input)
    },
